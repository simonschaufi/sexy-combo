...
;(function() {
    ...
    $.sexyCombo = function(selectbox, config) {
	    ...
	    this.wrapper.bind("click", function() {
	        self.wrapper.attr("sc:lastEvent", "click");								
	    });
	    ...
	    this.wrapper.bind("keyup", function(e) {
	        ...
	        self.wrapper.attr("sc:lastEvent", "key");								   
	    });	
	    ...
	    this.icon.bind("click", function(e) {
	        if (!self.wrapper.attr("sc:positionY"))	{
		        self.wrapper.attr("sc:positionY", e.pageY);	    	
		    }
	    });
    ...
    $sc.fn.extend({
	    ...
	    showList: function() {
		    ...
		    var bottomPos = parseInt(this.wrapper.attr("sc:positionY")) + inputHeight + listHeight;
	    ...
	    filter: function() {
		    if ("yes" == this.wrapper.attr("sc:optionsChanged")) {
		        var self = this;
			    ...
			    self.wrapper.attr("sc:optionsChanged", "");
		    }
	...
	filterFn: function(currentComboValue, itemValue, allComboValues) {
		if ("click" == this.wrapper.attr("sc:lastEvent")) {
		    return true;	
		}
	...
	getListMaxHeight: function() {
		...
		if (this.listWrapper.css("maxHeight")) {
	...
	changeOptions: function($select) {
        ...
        $select.each(function() {
			...
			$input.val("");
			$wrapper.attr("sc:optionsChanged", "yes");
			var $selectbox = $this;
		    $selectbox.parent().find("input[type='text']").val($selectbox.find("option:eq(0)").text());
		    $selectbox.parent().attr("sc:lastEvent", "click");
